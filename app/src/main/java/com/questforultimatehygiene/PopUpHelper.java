...
public class PopUpHelper {
    ...
    public void showQuestPopUp(final FragmentActivity context, int exp, int questIcon, int background, int buttonBackground, int questTitleId, final int questTitle, int questContentId, int questContent) {
